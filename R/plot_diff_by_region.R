  ...
  plot_diff_by_region<- function( data,
    ...
    # transforming the format of some variables
    ...
    if ( rlang::quo_text(group_var_enq)  == "Trigger_code") {
      ...
      message("Entering Trigger_code section")
      ...
      message("Subset non_consistent and consistent means created")
      ...
      message("Trigger_code_cons computed")
      ...
      message("trigger_code and Voltage renamed")
  ...
  plot_topoplots_by_custom_TW <- function (data_diff,
    ...
    for( tw_index in 1:length(tw_array)) {
      ...
      message(paste('Processing',lowBound,"-",upperBound))
